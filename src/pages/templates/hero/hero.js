	...
	if (click === 'Hello') {
		return (
				...
				<div className={'d-flex flex-wrap justify-content-around'}>
					...
					<div className={'d-flex justify-content-around main-color align-items-center'}>
						<img id={project.url}
							onClick={openWindow} src={"http://localhost:1337" + project.images.url}
							className='col-12 col-lg-7 pro-dimensions transition top'></img>
						<div className={'col-12 col-lg-5 project-color shadowed mr-5 pt-3 pl-4'}>
								<h3>{project.title}</h3>
